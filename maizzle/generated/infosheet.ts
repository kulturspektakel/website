...
<html lang="de" xmlns:v="urn:schemas-microsoft-com:vml">
  <head>
    ...
    <![endif]-->      <title>Informationen zum Auftritt von „${bandname}“ - Kulturspektakel ${eventYear}</title>
    <style>
h1 {
  margin-top: 0px;
  font-size: 1.5rem;
...
<ul>
<li style="margin-bottom: 0.5rem;">Große Bühne (Germeringer Str. 48, 82131 Gauting):<br>
https://maps.app.goo.gl/BnctABDcn6737C5Z9</li>
<li style="margin-bottom: 0.5rem;">Kultbühne (Germeringer Str. 37, 82131 Gauting):<br>
https://maps.app.goo.gl/U2X1fUh7sN4FVMFu6</li>
<li style="margin-bottom: 0.5rem;">Waldbühne (Wiesmahdstr. 9, 82131 Gauting):<br>
https://maps.app.goo.gl/JaDVhJqf4zVAm3Uu9</li>
</ul>
<p style="margin: 0px; margin-top: 0.5rem; margin-bottom: 0px;">Fahrzeuge, die nicht zur Anlieferung an die Bühnen müssen, können auf dem
