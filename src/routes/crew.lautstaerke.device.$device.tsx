...
import {DevicePicker} from '../components/lautstaerke/DevicePicker';
import {DeviceStatusLine} from '../components/lautstaerke/DeviceStatusLine';
...
import {NoiseToolbar} from '../components/lautstaerke/NoiseToolbar';
import {DeviceViewContext} from '../components/lautstaerke/deviceView';
import {ReferenceMicPanel} from '../components/lautstaerke/ReferenceMicPanel';
import {useReferenceMic} from '../components/lautstaerke/useReferenceMic';
...
// /crew/lautstaerke would be ambiguous. `projekt/` earns its own for the same reason.
export const Route = createFileRoute('/crew/lautstaerke/device/$device')({
  ...
  head: ({loaderData, params}) =>
    seo({
      title: `Lautstärke – ${
        loaderData?.assignment?.locationName ?? params.device
      }`,
    }),
});
