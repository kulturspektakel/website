...
export function NoiseLocationDialog({
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => onCreated(),
    onError: errorToast('Location could not be created'),
  });
                  ...
                  <Stack gap="4">
                    ...
                    {values.deviceId !== NO_DEVICE && (
                      <ConnectedField
                        ...
                        label="Assigned from"
                        type="datetime-local"
                        helperText={`Time in ${timeZone}. Defaults to the start of the project.`}
                      />
                    )}
                  </Stack>
                </DialogBody>
