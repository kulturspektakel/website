...
export type TwoFactorWhereInput = {
  ...
  account?: Prisma.StringFilter<"TwoFactor"> | string
  service?: Prisma.StringFilter<"TwoFactor"> | string
...
export type TwoFactorWhereUniqueInput = Prisma.AtLeast<{
  account_service?: Prisma.TwoFactorAccountServiceCompoundUniqueInput
  AND?: Prisma.TwoFactorWhereInput | Prisma.TwoFactorWhereInput[]
  OR?: Prisma.TwoFactorWhereInput[]
  NOT?: Prisma.TwoFactorWhereInput | Prisma.TwoFactorWhereInput[]
  account?: Prisma.StringFilter<"TwoFactor"> | string
...
export type TwoFactorScalarWhereWithAggregatesInput = {
  ...
  account?: Prisma.StringWithAggregatesFilter<"TwoFactor"> | string
  service?: Prisma.StringWithAggregatesFilter<"TwoFactor"> | string
...
export type TwoFactorAccountServiceCompoundUniqueInput = {
  account: string
  service: string
}
...
export type TwoFactorOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"account" | "service" | "secret", ExtArgs["result"]["twoFactor"]>
...
export interface TwoFactorDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const twoFactorWithAccountOnly = await prisma.twoFactor.findMany({ select: { account: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many TwoFactors and only return the `account`
   * const twoFactorWithAccountOnly = await prisma.twoFactor.createManyAndReturn({
   *   select: { account: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more TwoFactors and only return the `account`
   * const twoFactorWithAccountOnly = await prisma.twoFactor.updateManyAndReturn({
   *   select: { account: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface TwoFactorFieldRefs {
  readonly account: Prisma.FieldRef<"TwoFactor", 'String'>
  readonly service: Prisma.FieldRef<"TwoFactor", 'String'>
